...
const Sidebar = () => {
  ...
  return (
    <nav className='h-screen flex flex-col px-[14px] pt-[37px] pb-[27px] text-[#737791] overflow-y-auto sidebar overflow-x-hidden'>
      ...
      <div className='flex-1 flex items-end justify-start px-7 min-h-13'>
